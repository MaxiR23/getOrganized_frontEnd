...
const ModalFormTask = () => {
    ...
    const { taskModalForm, handleTaskModal, alert, showAlert, submitTask, task } = useProjects();
    ...
    useEffect(() => {
        if (task?._id) {
            ...
            setDeliveryDate(task.project_delivery_date?.split('T')[0])
    ...
    }, [task]) /* cada vez que tarea este cambiando va a hacer un re-render de ese componente */
    ...
    const handleSubmit = async (e) => {
        ...
        await submitTask({ id, name, deliveryDate, description, priority, project: params.id })
    ...
    const { msg } = alert;
    /* Voy a utilizar este componente como un Fragment */
    return (
        <Transition.Root show={taskModalForm} as={Fragment}>
                            ...
                            <div className="sm:flex sm:items-start">
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    <form className='my-10' onSubmit={handleSubmit}>
                                        ...
                                        <div className='mb-5'>
                                            <label className='text-gray-700 uppercase font-bold text-sm' htmlFor="project_delivery_date">
                                                Fecha de entrega
                                            </label>
                                            <input id='project_delivery_date' type="date"
