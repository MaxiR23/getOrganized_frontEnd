...
const DeleteCollabModal = ({ collab }) => {

    const { deleteCollab, deleteCollabModal, handleDeleteCollabModal } = useProjects();

    return (
        <Transition.Root show={deleteCollabModal} as={Fragment}>
            <Dialog as="div" className="fixed z-10 inset-0 overflow-y-auto" onClose={handleDeleteCollabModal}>
                        ...
                        <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
                            ...
                            <div className="hidden sm:block absolute top-0 right-0 pt-4 pr-4">
                                <button
                                    ...
                                    onClick={handleDeleteCollabModal}
                                >
                            ...
                            <div className="sm:flex sm:items-start">
                                ...
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    <div className='mt-2'>
                                        <p className='text-sm text-gray-500'> Si eliminas a este usuario, no podrá acceder al proyecto </p>
                                    </div>
                                </div>
                            </div>
...
export default DeleteCollabModal;