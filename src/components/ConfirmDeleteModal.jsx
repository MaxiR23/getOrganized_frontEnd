...
const ConfirmDeleteModal = ({ task }) => {
    ...
    const { deleteTask, handleModalDeleteTask, taskDeleteModal } = useProjects();

    return (
        <Transition.Root show={taskDeleteModal} as={Fragment}>
            <Dialog as="div" className="fixed z-10 inset-0 overflow-y-auto" onClose={handleModalDeleteTask}>
